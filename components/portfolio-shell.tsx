...
export default function PortfolioShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="portfolio-page relative bg-[var(--site-bg)]">
      <div
      ...
      <div className="pointer-events-none fixed inset-0 z-0 hidden overflow-hidden" aria-hidden="true">
      ...
      <AnimatePresence>
        {!introDone && (
          <motion.div
            ...
            className="fixed inset-0 z-[80] flex items-center justify-center bg-[var(--site-bg)]"
          >
            <div className="flex w-[min(16rem,78vw)] flex-col items-center">
              <div className="relative h-16 w-16 overflow-hidden rounded-full ring-2 ring-[#7CFFB2]/50">
                <Image src="/logo.png?v=2" alt="Mohsin Imran logo" fill sizes="64px" className="object-cover" priority />
              </div>
              <p className="mt-5 text-lg font-semibold tracking-tight text-[var(--site-ink)]">Mohsin Imran</p>
              <p className="mt-1 text-xs text-[var(--site-soft)]">Laravel, Next.js, and AI</p>
              <div className="mt-6 h-[3px] w-full overflow-hidden rounded-full bg-[var(--site-line)]">
                <motion.div
