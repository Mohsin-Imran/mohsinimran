...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      url: "https://www.linkedin.com/in/mohsin-imran-5833a9243/",
    ...
    },
    {
      ...
      url: "https://github.com/Mohsin-Imran",
    ...
    <footer id="footer" className="relative bg-[#0A0A0A] text-white py-16 overflow-hidden">
      ...
      <div className="container-fluid mx-auto px-4 relative z-10">
        ...
        >
            ...
            <div className="flex flex-wrap gap-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className={`group relative w-12 h-12 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:-translate-y-1 ${social.color} animate-fadeInUp`}
                  style={{ animationDelay: `${index * 100}ms` }}
                  aria-label={social.name}
                >
                  {/* Animated border */}
                  <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-yellow-400 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm" />
                  ...
                  {/* Glow effect */}
                  <div className="absolute inset-0 rounded-lg bg-yellow-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-pulse" />
                </a>
              ))}
            </div>
          </div>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 hover:translate-x-2 inline-block"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          >
            <h3 className="text-xl font-bold mb-4 text-yellow-400">More</h3>
            <ul className="space-y-2">
              {moreLinks.map((link) => (
                <li key={link.name}>
                  <a
        ...
        <div className="relative h-px bg-gradient-to-r from-transparent via-yellow-400 to-transparent mb-8" />
