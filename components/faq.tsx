...
export default function Faq() {
  ...
  return (
    <section id="faq" className="relative z-20 scroll-mt-24 border-t border-[var(--site-line)] bg-[var(--site-bg)] px-4 py-20 text-[var(--site-ink)] sm:px-6 lg:px-8 lg:py-24">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[280px_1fr] lg:gap-16">
        <div className="lg:sticky lg:top-28 lg:self-start">
          <p className="text-xs font-medium uppercase tracking-[0.22em] text-[var(--site-label)]">Questions</p>
            ...
            return (
              <div key={faq.question}>
                ...
                >
                  ...
                  <span className={`mt-1 shrink-0 text-lg leading-none text-[var(--site-label)] transition ${selected ? "rotate-45" : ""}`}>
                    +
                  </span>
                </button>
                <motion.p
                  ...
                  className="overflow-hidden text-sm leading-relaxed text-[var(--site-chip)] sm:text-base"
                >
